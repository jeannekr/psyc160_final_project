...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Samuel\\OneDrive\\Documents\\GitHub\\psyc160_final_project\\final_project.py',
...
for thisBlock in blocks:
    ...
    for thisTrial in trials:
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        flankerComponents = [image1, image2, image3, image4, image5, image6, image7, image8, key_resp]
